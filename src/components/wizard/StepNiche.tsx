...
const qualityOptions = [
  { value: "fast", label: "Fast", desc: "Speed first" },
  { value: "balanced", label: "Balanced", desc: "Best default" },
  { value: "premium", label: "Premium", desc: "Highest quality" },
];
    ...
    <div className="space-y-8">
      ...
      {topics.length > 0 && (
        <div className="animate-fade-in space-y-4">
          ...
          <div className="pt-1">
            <p className="text-[10px] font-label text-muted-foreground mb-2">VIDEO QUALITY</p>
              ...
              {qualityOptions.map((opt) => (
                <button
                  ...
                  className={`rounded-lg border px-3 py-2 text-left transition-all ${
                    (data.quality || "balanced") === opt.value
