          ...
          {features.map((f, i) => (
            <div key={f.title} className="surface-raised p-7 surface-hover group relative overflow-hidden border border-border/50 cursor-pointer" style={{
              ...
              <div className="relative z-10">
                ...
                {f.tag && (
                  <span className="inline-flex items-center gap-1 mt-4 px-2.5 py-1 rounded-full text-[9px] font-label text-accent bg-accent/8 border border-accent/15 group-hover:bg-accent/15 group-hover:border-accent/40 transition-all duration-300" style={{
                ...
                <p className="mt-4 text-[10px] uppercase tracking-[0.2em] text-muted-foreground/70"style={{
